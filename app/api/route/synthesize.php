...
Route::group('View/Synthesize', function () {
    ...
    Route::rule('Leader/sign', '/api/View/leaderSignView', 'GET');
    Route::rule('Leader/add', '/api/View/leaderAddView', 'GET');
});
...
Route::group('Synthesize', function () {
    ...
    Route::rule('leaderScore', '/api/Synthesize/leaderScore', 'POST');
    Route::rule('getLeaderScore', '/api/Synthesize/getLeaderScore', 'POST');
